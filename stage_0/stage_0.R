...
# LOAD DATA ---
sdo <- read.csv2(paste0(stage_0Dir, "/sdo_2024_all.csv"))
cedap <- read.csv2(paste0(cedapDir,"/",cedapFileName))

# =====================================================================
# DATE ----
# =====================================================================

sdo$dt_nasc <- ymd(sdo$dt_nasc)
sdo$dt_decesso <- ymd(sdo$dt_decesso)
...
admissionDate <- ymd(sdo_1yfup$dt_amm)
